    ...
    >
      ...
      {hover && (
        <div className="absolute bottom-11">
                ...
                datasets: [
                  {
                    ...
                    borderRadius: 7,
                    backgroundColor: "rgb(57, 131, 138, 0.5)",
                    indexAxis: "y",
                  },
                ],
              }}
          ...
          <div className="absolute -bottom-[11px] left-[calc(175px-12px)] border-t-[12px] border-t-white border-l-[15px] border-l-transparent border-r-[15px] border-r-transparent" />
        </div>
      )}
